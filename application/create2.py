...
blog2 = Blog(date_posted = date(2021, 4, 26),
             ...
             blog_title="A little bit about Anxhela Peristeri", blog_text="Anxhela Peristeri was born on 24 March 1986 into an Albanian family of the Eastern Orthodox faith in the city of Korçë, then part of the People's Republic of Albania, present Albania.[1][2][3] Her grandfather is of Greek origin.[4][5] After graduating from high school in Tirana, Peristeri and her family moved to Greece.[6][7] Describing her life in the latter country, she had stated that she experienced discrimination because of her Albanian origin.[8][9] In December 2001, Peristeri unsuccessfully participated in the 40th edition of Festivali i Këngës with the song 'Vetëm ty të kam'.[2] Later that year, she entered the Miss Albania national pageant in Tirana.[10][11] In June 2016, she emerged as the winner of the first season of Your Face Sounds Familiar.[12] Later, in December 2016, she debuted at Kënga Magjike with the song 'Genjështar', finishing in the second place.[13] Then in December 2017, she won the 19th edition of Kënga Magjike with the song 'E Çmëndur'.[14]",
             blog_views = 0)
